...
We are actively maintaining the following versions of **WATSON-MD-V7**. Please ensure you are using one of these versions for optimal security.
...
If you discover a security vulnerability in **WATSON-MD-V7**, we encourage you to report it responsibly. Please avoid publicly disclosing the vulnerability until we have had a chance to address it.

To report a vulnerability, please email us at:

- **Security contact**: [fourpencewatson5@gmail.com]
...
- GitHub releases
- WATSON-MD-V7 project documentation
...
Thank you for helping us keep **WATSON-MD-V7** secure!
